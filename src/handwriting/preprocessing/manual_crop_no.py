...
INPUT_FOLDER = Path(
    r"E:\FYP_RESEEARCH\DYSLEXAI_Code\DyslexAi-Handwriting-Module\Complete And Balance Hand-written Dataset\Dataset\No"
)

OUTPUT_FOLDER = Path(
    r"E:\FYP_RESEEARCH\DYSLEXAI_Code\DyslexAi-Handwriting-Module\Complete And Balance Hand-written Dataset\Dataset_Cropped\No"
